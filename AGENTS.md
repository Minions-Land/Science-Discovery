...
This file provides guidance to coding agents (Codex, Cursor, Gemini CLI, and others) when working with code in this repository. It is kept in sync with `CLAUDE.md` — edit both together, or edit `CLAUDE.md` and copy the result here.
