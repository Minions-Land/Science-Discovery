...
ROOT="/Users/mjm/MinionsOS/outline/ExperimentsOfMinionsos/FigureDraw3"
...
ALL_ARMS=(minionsos-v3)
ALL_FIGS=(grouped-bar line-errband scatter-fit heatmap box-violin 4panel-hero architecture roc-prc ridgeline dual-axis-time stacked-bar forest-plot sankey volcano network-graph latex-table equation-block cns-graphical-abstract imrad-section)
