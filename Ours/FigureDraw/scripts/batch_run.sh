...
ALL_ARMS=(minionsos figures4papers nature-figure research-paper-writing academic-plotting-orchestra pdf-vector-layout)
ALL_FIGS=(grouped-bar line-errband scatter-fit heatmap box-violin 4panel-hero architecture roc-prc ridgeline dual-axis-time stacked-bar forest-plot sankey volcano network-graph)
