...
tools:
version: 1
status: draft-from-SkillTest-R3
supersedes:
references: paper-literature-search, citation-audit, package-submission
provenance: SkillTest-R3.A-case-mixed-restrictions
---

# Skill — Data Availability Statement (DRAFT — SkillTest research zone)

> Draft from SkillTest R3.A. Do not move into `minions/roles/writer/skills/`
> until the user explicitly approves. See
> `SkillTest/synthesis/R3-synthesis.md` for evidence (18/18 vs 8/18 baseline).
