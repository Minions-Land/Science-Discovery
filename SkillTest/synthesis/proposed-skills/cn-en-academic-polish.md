...
tools:
version: 1
status: draft-from-SkillTest-R1
supersedes:
references: abstract-writing, apply-revisions
provenance: SkillTest-R1.C-case-intro-zh
---

# Skill — Chinese-to-English Academic Polish (DRAFT — SkillTest research zone)

> This is a draft from SkillTest, not a live MinionsOS skill. Do not move it
> into `minions/roles/writer/skills/` until the user explicitly approves the
> R1 synthesis port plan. See `SkillTest/synthesis/what-to-import.md` for
